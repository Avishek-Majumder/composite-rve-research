"""Input-contract scaffold for M8 periodized true-hole PBC mechanics.

This source establishes the new void-capable solver contract without
constructing an MPC, assembling FEM forms, solving mechanics, reconstructing
a stiffness tensor, extracting local metrics, or running machine learning.
"""
...
PBC_LOAD_SCHEMA = "m8_periodized_void_pbc_load_validation_v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Validate the M8 periodized true-hole "
            "void-capable PBC input contract."
        )
    )
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Authenticated periodized true-hole "
            "Gmsh mesh from src/24."
        ),
    )
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Authenticated m8_periodized_void_mesh_"
            "diagnostics_v1 JSON."
        ),
    )
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Authenticated paired periodized-void "
            "geometry-family JSON."
        ),
    )
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Permanent per-load validation JSON path. "
...
def main() -> int:
    ...
    print(
        "=== M8 PERIODIZED VOID PBC INPUT CONTRACT ==="
    )
    ...
    must(
        ...
        == FAMILY_SCHEMA,
        "periodized-void family schema authenticated",
    )
    ...
    must(
        ...
        is False,
        "family reused authenticated particle geometry",
    )
    ...
    must(
        ...
        is False,
        "geometry-family artifact predates MPC",
    )
    ...
    must(
        ...
        is False,
        "geometry-family artifact predates FEM",
    )
    ...
    must(
        ...
        == args.state,
        "selected geometry state identity is self-consistent",
    )
    ...
    must(
        ...
        == args.state,
        "mesh state matches requested geometry state",
    )
    ...
    must(
        ...
        == actual_family_sha,
        "mesh provenance points to authenticated geometry family",
    )
    ...
    must(
        ...
        is False,
        "mesh did not mutate protected M7 schema",
    )
    ...
    must(
        ...
        "mesh analytical particle area matches family",
    )
    ...
    must(
        ...
        "mesh gross area matches geometry family",
    )
    ...
    must(
        ...
        "locked particle/matrix stiffness ratio remains 10",
    )
    ...
    if selected_preflight_modes == 0:
        ...
        rve_level_candidates = [
            part
            for part in args.mesh.parts
            if (
                len(
                    part
                )
        ...
        must(
            ...
            == 1,
            "permanent output provenance resolves exactly one RVE level from runtime mesh path",
        )
        ...
        permanent_output = {
            "schema":
                "m8_periodized_void_pbc_load_validation_v1",
            ...
            "high_severity_mechanics_authorized_by_this_output":
                False,
        ...
        print()
        print(
            "M8_PERIODIZED_VOID_PBC_RESPONSE_PREFLIGHT_OK"
        )
        ...
        print()
        print(
            "M8_PERIODIZED_VOID_PBC_SOLVE_PREFLIGHT_OK"
        )
        ...
        print()
        print(
            "M8_PERIODIZED_VOID_PBC_LINEAR_PROBLEM_PREFLIGHT_OK"
        )
        ...
        print()
        print(
            "M8_PERIODIZED_VOID_PBC_FORM_PREFLIGHT_OK"
        )
        ...
        print()
        print(
            "M8_PERIODIZED_VOID_PBC_GAUGE_PREFLIGHT_OK"
        )
        ...
        print()
        print(
            "M8_PERIODIZED_VOID_PBC_MPC_TOPOLOGY_PREFLIGHT_OK"
        )

    else:
        print(
            "PASS — no DOLFINx import was performed by src/25 scaffold"
        )
    ...
    print()
    print(
        "M8_PERIODIZED_VOID_PBC_INPUT_CONTRACT_OK"
    )
